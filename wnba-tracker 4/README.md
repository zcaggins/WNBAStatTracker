...
- **Rookie Class** — real. The 2026 WNBA Draft results (pick order, college, team) are sourced from Yahoo Sports/NBC Sports/NESN draft trackers. Every rookie's per-game stat line is pulled directly from her individual ESPN player page (`espn.com/wnba/player/_/id/.../<name>`), current as of July 15, 2026.
...
- Dark color scheme with WNBA orange (Princeton Orange, `#F57B20`) as the primary accent (`style.css` `:root` variables) — swap the hex values there to retheme.
